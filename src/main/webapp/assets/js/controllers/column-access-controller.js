define([
    ...
    'use strict';
    controllers.controller('ColumnAccessController', ['$scope', '$http', '$timeout', 'CommonService', function ($scope, $http, $timeout, CommonService) {
    	
    	// 加载访问数据
		$scope.renderLoginAccess = function(dateDimension, nums) {
			$http({
    			method: 'GET',
    			url: 'stat/getStatAccessChart.do?dateDimension=' + dateDimension + '&moduleType=column',
