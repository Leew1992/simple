define([
    ...
    controllers.controller('MenuListController', ['$scope', '$http', 'CommonService', function ($scope, $http, CommonService) {
    	...
    	var renderSystemTree = function() {
    		var url = "system/getSystemTreeForMenuList.do";
