define([
    ...
    'use strict';
    controllers.controller('AttachmentUploadController', ['$scope', '$http', '$timeout', 'CommonService', function ($scope, $http, $timeout, CommonService) {
    	
    	// 加载访问数据
		$scope.renderLoginAccess = function(dateDimension, nums) {
			$http({
    			method: 'GET',
    			url: 'stat/getRecentColumnAccessesByDateDimension.do?dateDimension=' + dateDimension + '&nums=' + nums,
