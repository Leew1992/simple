define([
    ...
    controllers.controller('MenuFormController', ['$scope', '$http', 'CommonService', function ($scope, $http, CommonService) {
    	// 定义全局变量
    	var idGroup = '0', idSystem, $systemTree = $("#systemTree"), $superMenuTree = $("#superMenuTree");
    	...
    	if(operateType == "editMenu") {
    		...
    		$http({
    			method: 'GET',
    			url: 'menu/getMenuById.do?idMenu=' + idMenu,
    	...
    	var renderSystemTree = function() {
        	var url = "system/getSystemTreeForMenuForm.do";
    	...
    	$scope.openSuperMenuTree = function() {
    		...
    		$superMenuTree.setting.async.url = "menu/getMenuTreeForMenuAssign.do?idSystem="+idSystem+"&idMenu="+idMenu;
