    ...
    controllers.controller('UserFormController', ['$scope', '$http', 'CommonService', 'fileUpload', function ($scope, $http, CommonService, fileUpload) {
    	...
    	if(idUser) {
    		...
    		$http({
    			...
    			$("#avatarImg").attr('src', 'attachment/getAvatar.do?filePath=' + $scope.user.avatarUrl);
    	...
    	var renderGroupTree = function() {
        	var url = "group/getGroupTreeForUserForm.do";
    	...
    	$scope.uploadSuccess = function(data) {
    		$("#avatarImg").attr('src', 'attachment/getAvatar.do?filePath=' + data.result);
    	}
    	...
    	$scope.uploadFile = function() {
    		...
    		if(file) {
    			var uploadUrl = "attachment/uploadAvatar.do";
