define([
    ...
    services.service('CommonService',  [function(){
    	return {
    		...
    		/********************** tree ************************/
    		noEventsParamsCallbackSetting : function (check,url,dataFilter) {
    			var setting = {
    				check : {
    					enable : check
    				},
    		...
    		noEventsParamsSetting : function (check,url,dataFilter,callback) {
    			var setting = {
    				check : {
    					enable : check
    				},
    		...
    		noEventsCallbackSetting : function (check,url,params,dataFilter) {
    			var setting = {
    				check : {
    					enable : check
    				},
    		...
    		noEventsCallbackSettingForRadio : function (check,url,params,dataFilter) {
    			var setting = {
    				check : {
    					enable : check,
    					chkStyle : "radio",
    		...
    		noEventsParamsCallbackSettingForRadio : function (check,url,dataFilter) {
    			var setting = {
    				check : {
    					enable : check,
    					chkStyle : "radio",
    		...
    		noEventsSetting : function (check,url,params,dataFilter,callback) {
    			var setting = {
    				check : {
    					enable : check
    				},
    		...
    		noParamsSetting : function (check,addHoverDom,removeHoverDom,url,dataFilter,callback) {
    			var setting = {
    				check : {
    					enable : check
    				},
    		...
    		setting : function (check,addHoverDom,removeHoverDom,url,params,dataFilter,callback) {
    			var setting = {
    				check : {
    					enable : check
    				},
