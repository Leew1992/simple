...
public class CommentServiceImpl implements CommentService {
	...
	public ResultDTO saveComment(CommentDTO commentDTO) {
		commentDTO.setCreatedBy("system");
		commentDTO.setCreatedDate(new Date());
		commentDTO.setUpdatedBy("system");
		...
		postCommentDO.setCreatedBy("system");
		postCommentDO.setCreatedDate(new Date());
		postCommentDO.setUpdatedBy("system");
		postCommentDO.setUpdatedDate(new Date());
