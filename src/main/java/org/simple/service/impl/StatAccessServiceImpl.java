...
public class StatAccessServiceImpl implements StatAccessService {
	...
	private static final String ACCESS_COUNT = "访问量";
	...
	public Map<String, Object> getStatDayAccessCount(String accessDate) {
		...
		Map<String, Object> dayAccessMap = new HashMap<String, Object>();
		for(Map<String, Object> statDayAccess : statDayAccessList) {
			dayAccessMap.put((String)statDayAccess.get("accessModule"), statDayAccess.get("accessCount"));
		}
		return dayAccessMap;
	}
	...
	public Map<String, Object> getStatWeekAccessCount(String accessDate) {
		...
		Map<String, Object> weekAccessMap = new HashMap<String, Object>();
		for(Map<String, Object> statWeekAccess : statWeekAccessList) {
			weekAccessMap.put((String)statWeekAccess.get("accessModule"), statWeekAccess.get("accessCount"));
		}
	...
	public Map<String, Object> getStatMonthAccessCount(String accessDate) {
		...
		Map<String, Object> monthAccessMap = new HashMap<String, Object>();
		for(Map<String, Object> statMonthAccess : statMonthAccessList) {
			monthAccessMap.put((String)statMonthAccess.get("accessModule"), statMonthAccess.get("accessCount"));
		}
	...
	public Map<String, Object> getStatYearAccessCount(String accessDate) {
		...
		Map<String, Object> yearAccessMap = new HashMap<String, Object>();
		for(Map<String, Object> statYearAccess : statYearAccessList) {
			yearAccessMap.put((String)statYearAccess.get("accessModule"), statYearAccess.get("accessCount"));
		}
	...
	public ResultDTO increaseStatDayAccess(StatDayAccessDO statDayAccess) {
		...
		return new ResultDTO(true, MessageConsts.LOAD_SUCCESS);
	}
	...
	public ChartDTO getStatAccessChart(String dateDimension, String moduleType) {
		...
		if("login".equals(moduleType)) {
			moduleCodes = LOGIN_MODULES_CODE;
			moduleNames = LOGIN_MODULES_NAME;
		} else {			
			moduleCodes = COLUMN_MODULES_CODE;
			moduleNames = COLUMN_MODULES_NAME;
		}
		Map<String, Object> paramMap = new HashMap<String, Object>();
		paramMap.put("modules", moduleCodes);
		...
		ChartDTO chartDTO = new ChartDTO();
		chartDTO.setDatasets(dataSetList);
		chartDTO.setLabels(moduleNames);
		return chartDTO;
	}
}
