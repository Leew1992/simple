...
public class CategoryController {
	 ...
	 * 获取类别树
	 */
	@RequestMapping("/getCategoryTreeForCommentList.do")
	@ResponseBody
	public List<TreeNode> getCategoryTreeForCommentList() {
		return categoryService.getCategoryTreeForCommentList();
	}
	
	/**
	 * 获取类别树
	 */
	@RequestMapping("/getCategoryTreeForCategoryConfig.do")
	@ResponseBody
	public List<TreeNode> getCategoryTreeForCategoryConfig() {
		return categoryService.getCategoryTreeForCategoryConfig();
	}
