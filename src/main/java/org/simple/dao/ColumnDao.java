...
public interface ColumnDao {
	 ...
	 * 获取栏目树
	 */
	List<TreeNode> getColumnTreeForPostList();

    /**
     * 获取栏目树
     */
    List<TreeNode> getColumnTreeForPostForm(String idPost);
    
    /**
     * 获取栏目树
     */
    List<TreeNode> getColumnTreeForColumnConfig();

    /**
     * 保存栏目信息
     */
    String saveColumn(ColumnDO columnDO);
