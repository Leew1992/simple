...
public interface GroupDao {
	 ...
	 * 获取分组树
	 */
	List<TreeNode> getGroupTreeForUserList();
	
	/**
	 * 获取分组树
	 */
	List<TreeNode> getGroupTreeForUserForm(String idUser);
	
	/**
	 * 获取分组树
	 */
	List<TreeNode> getGroupTreeForRoleForm(String idRole);
	
	/**
	 * 获取分组树
	 */
	List<TreeNode> getGroupTreeForGroupConfig();
